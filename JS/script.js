...
buttons[12].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/Sam Deep.jfif";
  song.src = "./assets/Songs/Sam Deep.mp3";
  songName.innerText = "Sam Deep";
  songBy.innerText = "Thokoza ft. ";
  title.innerText = "Thokoza";
  download.href = "./assets/Songs/Sam Deep.mp3";
  aboutSong.innerText = "Music has the power to uplift your mood and also makes you feel  the warmth of emotions in the most memorable ways. 'Sam Deep ft. Thokoza' was released in 2022.";
});

buttons[13].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/Azkhale.jpg";
  song.src = "./assets/Songs/Azkhale.mp3";
  songName.innerText = "Kabza";
  songBy.innerText = "Kabza ft. ";
  title.innerText = "Azkhale";
  download.href = "./assets/Songs/Azhale.mp3";
  aboutSong.innerText = "Music has the power to uplift your mood and also makes you feel  the warmth of emotions in the most memorable ways. 'Kabza ft. Azkhale' was released in 2022.";
});

buttons[14].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/Bawo.jpg";
  song.src = "./assets/Songs/Bawo.mp3";
  songName.innerText = "Kabza";
  songBy.innerText = "Bawo ft. ";
  title.innerText = "Kabza";
  download.href = "./assets/Songs/Bawo.mp3";
  aboutSong.innerText = "Music has the power to uplift your mood and also makes you feel  the warmth of emotions in the most memorable ways. 'Kabza ft. Bawo' was released in 2022.";
});

buttons[15].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/Xola.jpg";
  song.src = "./assets/Songs/Xola.mp3";
  songName.innerText = "Kabza";
  songBy.innerText = "Xola ft. ";
  title.innerText = "Kabza";
  download.href = "./assets/Songs/Xola.mp3";
  aboutSong.innerText = "Music has the power to uplift your mood and also makes you feel  the warmth of emotions in the most memorable ways. 'Kabza ft. Xola' was released in 2022.";
});

buttons[16].addEventListener("click", () => {
  icon.src = "./assets/Image/play.png";
  photo.src = "./assets/Image/Bayasaba.jpg";
  song.src = "./assets/Songs/Bayasaba.mp3";
  songName.innerText = "Kabza";
  songBy.innerText = "Bayasaba ft. ";
  title.innerText = "Kabza";
  download.href = "./assets/Songs/Bayasaba.mp3";
  aboutSong.innerText = "Music has the power to uplift your mood and also makes you feel  the warmth of emotions in the most memorable ways. 'Kabza ft. Bayasaba' was released in 2022.";
});
